...
const SearchInput = ({
	...
	return (
		<div className="flex flex-col gap-1">
			...
			<div
				className={clsx(
					"w-full flex items-center justify-around my-[2px] rounded-md placeholder:text-emerald-700 border-b border-transparent focus-within:border-emerald-500",
					error
						? "bg-red-50 focus-within:border-red-500"
						: "bg-[#E8FCF2] focus-within:border-emerald-500"
				)}>
				<input
					id={name}
					name={name}
