...
export const Footer = () => {
	return (
		<footer className="w-full h-fit mt-6 px-4 py-6 md:p-14 gap-y-8 flex flex-col md:flex-row items-center justify-between font-light bg-emerald-900 text-white text-xs shadow-inner border-t-8 border-emerald-200">
